...
class LandingPagePostSerializer(serializers.ModelSerializer):
    class Meta:
        model = Post
        fields = ('id', 'thumbnail_image', 'banner_image', 'banner_image_alt_description', 'updated_at', 'created_at',
                  'blog_duration_to_read', 'slug', 'title', 'thumbnail_image_alt_description', 'meta_description')
