...
class ActivityAdmin(ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Tour Details", {
            "fields": ("heroImg", "coverImg","avatar_image","banner_image","location", "duration", "trip_grade","max_group_size", "best_time","ratings","availableStart", "availableEnd","trek_map", "max_altitude","altitude_chart","difficulty_level","trip_start","trips_end","group_style","best_season","activity_type")
        }),
        ("Tour Description", {
            "fields": (
                "tour_description",
